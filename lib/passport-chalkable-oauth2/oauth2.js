...
Strategy.prototype.userProfile = function(accessToken, done) {
  ...
  this._oauth2.get('https://chalkable.com/Person/Me.json', accessToken, function (err, body, res) {
    ...
    try {
      ...
      if (json.data.pictureid)
        profile.photos = [{ value:'https://chalkable.com/PersonPicture/Read?pictureId=' + json.pictureid + '&width=' + json.pictureheight + '&height=' + json.picturewidth }];
